...
<main>
          ...
          <div class="col-lg-5 mb-lg-auto  mb--200" style="z-index:1000;">
              ...
              <div class="card bg-secondary border-0">
                ...
                <div class="card-header form-header">
                  <div class="text-white text-center"><span> Fill out the form  to schedule your SEAT </span></div>
    ...
    <section> 
      <div class="container  pt-lg-0 mt--100" >
        <div class="row">
          <div class="col-lg-6 ">
            <div class="card ">
                  ...
                  <div class="carousel-inner">
                    ...
                    <!-- <div class="carousel-item  py-3 px-3">
                      <div class="py-3 text-center">
                        <p> named Duden flows by their place and supplies it with the necessary regelialia.</p>
                        <i class="ni ni-bell-55 ni-3x"></i>
                      </div>
                    </div>
                    <div class="carousel-item  py-3 px-3">
                      <div class="py-3 text-center">
                        <p> 3 flows by their place and supplies it with the necessary regelialia.</p>
                        <i class="ni ni-bell-55 ni-3x"></i>
                      </div>
                    </div>
                    <div class="carousel-item  py-3 px-3">
                      <div class="py-3 text-center">
                        <p> 4 flows by their place and supplies it with the necessary regelialia.</p>
                        <i class="ni ni-bell-55 ni-3x"></i>
                      </div>
                    </div> -->
    ...
    <!-- Open the Learning Outcome  -->
    <section class="section section-lg pb-5 section-components">
      <!-- Open Container -->
      <div class="container ">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 learning-outcome">
            <h2 class="brand_color padding-bottom-30" >Learning Outcome</h2>
    ...
    </section> <!-- Close the Learning Outcome -->
