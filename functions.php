...
function hranalytics_enqueue_styles() {
  ...
  function hranalytics_enqueue_scripts() {
    ...
    wp_enqueue_script( 'jquery-js', get_stylesheet_directory_uri() . './assets/vendor/bootstrap/bootstrap.min.js', ['jquery'], time(), 'true' );
    wp_enqueue_script( 'argon-js', get_stylesheet_directory_uri() . './assets/js/argon.js', ['jquery'], time(), 'true' );
